...
function register(req, res, next) {         
               ...
               db.users.insert(data, function(err, result) {
                   ...
                   res.send({
                       "status": "sucessfully registered please check your inbox for actiation"
                   });
               });
}
...
refer this link:https://www.nexmo.com/blog/2016/10/19/how-to-send-sms-messages-with-node-js-and-express-dr/ 
for mobile verification code
* Allow to access phone book of registered user
* Synchronize the Register user phone book with Database to display the list of users
